...
EXE_DEPS = assembler.o utils_code_functions.o process_first_pass.o process_second_pass.o process_macros.o instructions.o table_operations.o utils_functions.o write_files.o # Deps for exe
